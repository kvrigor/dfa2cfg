''' <summary>
''' Data structure for deterministic finite automaton (DFA) objects.
''' </summary>
''' <remarks>
...
#Region "Properties"
    ''' <summary>
    ''' Returns a string array of all the states of the DFA.
    ''' </summary>
    ''' <returns></returns>
    ...
    ''' <summary>
    ''' Returns a string array of the input symbols.
    ''' </summary>
    ''' <returns></returns>
    ...
    ''' <summary>
    ''' Returns an array of all the transition functions.
    ''' </summary>
    ''' <returns></returns>
    ...
    ''' <summary>
    ''' Returns a string array of the accept states.
    ''' </summary>
    ''' <returns></returns>
